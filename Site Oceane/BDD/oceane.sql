...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 24 déc. 2022 à 10:54
...
CREATE TABLE IF NOT EXISTS `bateau_secteur` (
...
CREATE TABLE IF NOT EXISTS `niveau_accessibilite` (
...
) ENGINE=InnoDB AUTO_INCREMENT=60497 DEFAULT CHARSET=utf8;
